                            ...
                            <form action="{{ route('admin.personal-growth.store') }}" method="POST"
                                ...
                                {{-- <div class="form-group row mb-4">
                                    ...
                                    <div class="input-group input-daterange">
                                        <input type="text" class="form-control" name="startDate" value="2012-04-05">
                                        <div class="input-group-addon">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"> To
                                            </label>
                                        </div>
                                        <input type="text" class="form-control" name="dueDate" value="2012-04-19">
                                    </div>
                                </div> --}}
                                ...
                                {{-- <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Range</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" id="ranged" name="startDate" class="form-control" >
                                    </div>
                                </div>
                                 <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Due Range</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" id="simple" name="dueDate" class="form-control" >
                                    </div>
                                </div> --}}
