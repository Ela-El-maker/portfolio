                        ...
                        <div class="card-body">
                            <form action="{{route('admin.skill-section-setting.update', 1)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <textarea name="sub_title" id="" cols="30" rows="10" class="form-control" style="height: 100px">{!!$skillSection->sub_title!!}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#image-preview').css({
                'background-image': 'url("{{$skillSection->image}}")',
